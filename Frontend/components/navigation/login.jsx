    ...
    if (window.user.username) {
      login = (
        <ul className="nav nav-pills">
          <li role="presentation" onClick={this.handleAllListingsClick}><a href="#" className="pill-text logo-hover"><img src={'https://www.pleasantsolutions.com/media/redesign/icon_experts.png'} alt="FOFSLOGO" className="logo"/>Free Or For Sale</a></li>
