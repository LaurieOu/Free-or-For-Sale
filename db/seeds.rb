...
#   {username: "sam.greenholt", email: "lilliana@damore.net", password_digest: "$2a$10$QfPGnMlskN4cW5.6p1GCFukaQ23hzPvtyTYf8b8UWAXdNdCgam2sy", session_token: "LoOnmSVQEbqQnifMvJvx9A", university_id: 2, image: "http://a3.files.biography.com/image/upload/c_fill,cs_srgb,g_face,h_300,w_300/MTE1ODA0OTcxOTUyMDE0ODYx.png"},
#   {username: "jonathan.feest", email: "delphia_eichmann@adams.info", password_digest: "$2a$10$rZUJFbU3BMeiTBuF4OGo/.BQCyNYgcfZpXTgsYbYIeaNEpuLfXiee", session_token: "ysTtlMSAvuq53ohOCen7NA", university_id: 3, image: "http://images.apple.com/pr/bios/images/cook_hero.png"},
#   {username: "nathan", email: "viva_stiedemann@grant.biz", password_digest: "$2a$10$9x7URVYgomWUNhHE7dTrxep3Je7RhY3xa1guSWULOPG54tTcp6sry", session_token: "B7WaGpFDnKAut8PSARSZmw", university_id: 5, image: "http://static1.businessinsider.com/image/50c747cf6bb3f74a29000001/larry-page-promises-google-is-going-to-make-a-lot-of-money-from-android-and-ios.jpg"},
